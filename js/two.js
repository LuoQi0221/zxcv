...
function del(num){
    if(num==1){
       var t= document.getElementById("cartList").firstElementChild.nextElementSibling;
        t.parentNode.removeChild(t);
    }else{
        var t= document.getElementById("cartList").lastElementChild.previousElementSibling;
        t.parentNode.removeChild(t);
    }
      delNode.parentNode.removeChild(delNode);
}
function jie(){
	var title=document.getElementById("name1").innerHTML();
	alert(title);
}
